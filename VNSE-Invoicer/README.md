...
### Validate & Export
- EN 16931 profile-aware validation with detailed error messages before export
- Export as **Factur-X** or **ZUGFeRD** with embedded CII XML (PDF/A-3b compliant)
- Professional PDF layout with blue accent theme and automatic page breaks
...
- **E-Invoice Premium Module**: Factur-X/ZUGFeRD CII XML generation, validation, and PDF reading
- **Encryption Premium Module**: PAdES-B-B digital signatures with RSA PKCS#1 v1.5
- **Barcode Module**: Code128 barcode rendering on invoices
- **Core Library**: PDF generation, font embedding, page layout, compression
