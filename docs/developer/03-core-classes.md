...
**Parameters**:
- `file` - FolderItem for output file
...
**Example**:
```xojo
pdf.SaveToFile("/Users/john/Desktop/output.pdf")
```
...
**Returns**: PDF document as MemoryBlock

**Description**: Generates and returns the PDF as a MemoryBlock. Xojo PDFDocument-compatible method.
