...
If hasPremiumVNSZlibModule Or Not TargetiOS Then
...
**Solution**: Ensure VNSPDFDocument includes the filter declaration when `hasPremiumVNSZlibModule` is true.
